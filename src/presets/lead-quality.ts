...
export const questions: Questions = {
  quality: {
    type: "score",
    instructions: "Assess the commercial quality of this inbound lead from 0 to 4 using specificity, apparent fit, intent, and readiness. Do not infer facts that are absent from the message.",
    criteria: [
